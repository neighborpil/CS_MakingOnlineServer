...
namespace NetworkServices
{
    ...
    public class CPacket
    {
        ...
        public static void destory(CPacket packet)
        {
        ...
        public string pop_string()
        {
            ...
            short len = BitConverter.ToInt16(this.buffer, this.position);
            this.position += sizeof(short);
        ...
        public void set_protocol(short protocl_id)
        {
        ...
        public void push(string data)
        {
            ...
            this.position += sizeof(short); // 헤더

            temp_buffer.CopyTo(this.buffer, this.position);
            this.position += temp_buffer.Length; // 바디
        }
