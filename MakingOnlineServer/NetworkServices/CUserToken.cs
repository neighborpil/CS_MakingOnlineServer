...
namespace NetworkServices
{
    public class CUserToken
    {
        ...
        public SocketAsyncEventArgs receive_event_args { get; set; }
        public SocketAsyncEventArgs send_event_args { get; set; }
        ...
        public void process_send(SocketAsyncEventArgs e)
        {
            ...
            lock (this.cs_sending_queue)
            {
                ...
                lock (cs_count)
                {
                    ...
                    {
                        Console.WriteLine($"process send : {e.SocketError}, transferred {e.BytesTransferred}, sent count {sent_count}");
                    }
                }
