...
public class CRemoteServerPeer : IPeer
{
    ...
    WeakReference net_eventmanager;
    ...
    public void set_eventmanager(CNetEventManager event_manager)
    {
        this.net_eventmanager = new WeakReference(event_manager);
    }
    ...
    void IPeer.on_message(Const<byte[]> buffer)
    {
        ...
        (this.net_eventmanager.Target as CNetEventManager).enqueue_network_message(msg);
    }

    void IPeer.on_removed()
    {
        (this.net_eventmanager.Target as CNetEventManager).enqueue_network_event(NETWORK_EVENT.disconnected);
    }
